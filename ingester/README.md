...
Version 0.13, 23 September 2026.
...
| Summary | `bin/summary`, after every S3 | The written transcript's files and the Claude Code session files | `evaluation/Tnnn-summary.md`: model, time, tokens, output, verdict outcomes, comparison with the previous transcript; `evaluation/ingestions.md` rebuilt with a column per transcript | None |
